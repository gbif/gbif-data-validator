 ...
 * Mapping is done by InterpretationRemarkEvaluationTypeMapping and covered by unit test.
 */
public enum EvaluationType {
  ...
  RESOURCE_CREATOR_MISSING_OR_INCOMPLETE(EvaluationCategory.METADATA_CONTENT),

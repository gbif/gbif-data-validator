...
public class ValidatorWsConfiguration {
  ...
  @Bean
  public UploadFileManager uploadedFileManager(@Value("${upload.workingDirectory}") String uploadWorkingDirectory,
                                               @Value("${storePath}") String storePath,
                                               DownloadFileManager downloadFileManager) throws IOException  {

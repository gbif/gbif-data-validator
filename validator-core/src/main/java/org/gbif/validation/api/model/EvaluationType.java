...
public enum EvaluationType {
  ...
  GEOSPATIAL_DATA_NOT_PROVIDED(EvaluationCategory.OCCURRENCE_RECORD_COMPLETENESS),
  TEMPORAL_DATA_NOT_PROVIDED(EvaluationCategory.OCCURRENCE_RECORD_COMPLETENESS),
  TAXONOMIC_DATA_NOT_PROVIDED(EvaluationCategory.OCCURRENCE_RECORD_COMPLETENESS),

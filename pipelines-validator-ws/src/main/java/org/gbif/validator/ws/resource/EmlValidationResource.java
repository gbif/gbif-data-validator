...
public class EmlValidationResource {
  ...
  public EmlValidationResource(ValidatorWsConfiguration.XmlSchemaLocations schemaLocations, SchemaValidatorFactory schemaValidatorFactory) {
  ...
  /**
   * Translates a Throwable into a XmlSchemaValidator.ValidationResult if possible.
  ...
  private XmlSchemaValidator.ValidationResult toValidationError(Throwable ex) {
    if (ex instanceof SAXParseException) {
      return XmlSchemaValidator.ValidationResult.builder()
        .errors(Collections.singletonList(XmlSchemaValidator.ValidationError.builder()
  ...
  public List<String> getSchemas() {
    return Arrays.asList(schemaLocations.getEml(),
                         schemaLocations.getEmlGbifProfile());
  }
}

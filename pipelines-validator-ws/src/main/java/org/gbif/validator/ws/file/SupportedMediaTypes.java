...
public class SupportedMediaTypes {
  ...
  public static final List<String> TABULAR_CONTENT_TYPES = ImmutableList.of(MediaType.TEXT_PLAIN_VALUE,
          TEXT_CSV, TEXT_TSV);

  public static final List<String> SPREADSHEET_CONTENT_TYPES = ImmutableList.of(
          APPLICATION_EXCEL,
          APPLICATION_OFFICE_SPREADSHEET,
          APPLICATION_OPEN_DOC_SPREADSHEET);
